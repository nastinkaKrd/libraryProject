...
public class ElementWebController {
    ...
    public String addElement(@RequestParam(name = "id") int id, @RequestParam(name = "title") String title, @RequestParam(name = "type") String type
        ...
        printedElementService.addElement(new PrintedElement(id, title, type, style, amount, year, num,
                new PublishCompany(publishId, companyName)), new Author(authorId, authorName), new PublishCompany(publishId, companyName));
        return "redirect:../../hello";
    }
}
