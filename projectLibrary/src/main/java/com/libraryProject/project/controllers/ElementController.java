...
import com.libraryProject.project.dto.ElementDataDto;
...
import com.libraryProject.project.services.PrintedElementServiceImplements;
...
public class ElementController {
    ...
    public void addElement(@RequestBody ElementDataDto printedElement){
        printedElementService.addElement(new PrintedElement(printedElement.getElementId(), printedElement.getTitle(),
                printedElement.getType(), printedElement.getStyle(), printedElement.getAmountOfElements(),
                printedElement.getYearOfPublish(), printedElement.getNumOfPublish(), new PublishCompany(printedElement.getPublishCompanyId(), printedElement.getPublishCompanyName())),
                new Author(printedElement.getAuthorId(), printedElement.getAuthorName()),
                new PublishCompany(printedElement.getPublishCompanyId(), printedElement.getPublishCompanyName()));
    }
